...
class EightPuzzle:
    ...
    def process(self):
        ...
        start = self.generateRandomArray()
        print("This is the randomy generated Array. ")
        ...
        for i in range(3):
            for j in range(3):
                ...
                if j==2:
                    print()
        print("This process will find the goal state using A* algorithim.")
        ...
        while True:
            ...
            if(self.h(cur.data,goal) == '0'):
                ...
                print("Visited Nodes = ")
                print("Found at level # ")
                break
            for i in cur.expandNodes():
